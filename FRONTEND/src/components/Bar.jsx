        ...
        <div className="w-1/6 flex flex-col bg-white h-full rounded-2xl ">
          ...
          <div className="w-12/12 flex flex-row rounded-b-2xl bg-white h-3/6">
            <div
              ...
              className="flex justify-center items-center  hover:bg-gray-100 hover:cursor-pointer w-6/12 bg-white rounded-bl-2xl border-r border-t"
            >
              <svg
            ...
            <div
              ...
              className="flex justify-center items-center  hover:bg-gray-100 hover:cursor-pointer w-6/12 bg-white border-l border-t rounded-br-2xl"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                id="Outline"
