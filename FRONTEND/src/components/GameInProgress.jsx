            ...
            <div className="flex items-center gap-2 relative z-0 w-full mb-6 group">
              ...
              <div className="w-2-12">
                <button
                  type="button"
                  onClick={addPlayer}
                  className="flex items-center gap-2 justify-center bg-blue-600 text-white rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                >
                  {"Player "}
                  <svg
                    id="Layer_1"
